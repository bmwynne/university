...
def flood(color_of_tile, flooded_list, screen_size):
    ...
    while i < len(flooded_list): 
        ...
        if in_bounds(right(flooded_list[i]), screen_size) and (right(flooded_list[i])) not in flooded_list and color_of_tile[flooded_list[i]] == color_of_tile[right(flooded_list[i])]:
                    flooded_list.append(right(flooded_list[i]))
        if in_bounds(down(flooded_list[i]), screen_size) and (down(flooded_list[i])) not in flooded_list and color_of_tile[flooded_list[i]] == color_of_tile[down(flooded_list[i])]:
                    flooded_list.append(down(flooded_list[i]))
        if in_bounds(left(flooded_list[i]), screen_size) and (left(flooded_list[i])) not in flooded_list and color_of_tile[flooded_list[i]] == color_of_tile[left(flooded_list[i])]:
